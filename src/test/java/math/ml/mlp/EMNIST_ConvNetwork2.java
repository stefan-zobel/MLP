...
/**
 * Three convolutional blocks and a small dense head, so that the convolutions carry a real
 * share of the parameters rather than the 1.1 % they hold in {@link EMNIST_ConvNetwork1}.
 *
 * <p>Widening that network would not have done it: the dense layer grows with the channel
 * count, so 32/64 moves the convolutional share to 2.2 % and no further. A third block and
 * a third pooling step shrink the head instead, which is why this is the smaller network of
 * the two despite being the deeper one.
 */
public class EMNIST_ConvNetwork2 extends AbstractNetwork {

    public EMNIST_ConvNetwork2() {
    }
    ...
    public static void main(String[] args) {
        ...
        EMNIST_ConvNetwork2 net = new EMNIST_ConvNetwork2();
